...
public class OrderService {
    ...
    public List<OrderResponseDto> findAll() throws InterruptedException {
...
//        List<Order> orders = orderRepository.findAllOrdersEntityGraphToOneFields();
        System.out.println("HIKARI B " + dataSource.getHikariPoolMXBean().getActiveConnections());
        Thread.sleep(7000);
...
//        System.out.println("MAPPERS AFTER THIS");
        ...
        System.out.println("HIKARI C " + dataSource.getHikariPoolMXBean().getActiveConnections());
        Thread.sleep(7000);
